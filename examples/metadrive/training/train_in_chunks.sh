...
for (( i=0; i<$num_chunks; i++ )); do
    ...
    if [ $i -eq 0 ]; then
        ...
        python run_js_iql_waymo.py -f -dt --num_of_scenarios 10000 --steps $step_per_chunk
        ...
        # python /home/xinyi/src/safe-sb3/examples/metadrive/training/run_iql_waymo.py -f  --num_of_scenarios 10000 --steps $step_per_chunk  
    else
        # DT iql, uncomment this
        python run_js_iql_waymo.py -dt --num_of_scenarios 10000 --steps $step_per_chunk
        ...
        # iql only, uncomment this
        # python /home/xinyi/src/safe-sb3/examples/metadrive/training/run_iql_waymo.py --num_of_scenarios 10000 --steps $step_per_chunk  
    fi
done