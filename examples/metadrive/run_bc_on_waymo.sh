...
# alternatively on server:
python examples/metadrive/run_bc_waymo.py --pkl_dir ~/src/data/metadrive/pkl_9/ --h5py_path ~/src/data/metadrive/h5py/bc_9_900.h5py --use_diff_action_space True --output_dir ~/src/data/metadrive/saved_bc_policy --num_of_scenarios 900 --steps 1000000 --save_freq 10000 
