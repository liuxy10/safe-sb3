...
# python examples/metadrive/run_sac_waymo.py --pkl_dir ~/src/data/metadrive/pkl_9/ --output_dir ~/src/data/metadrive/saved_sac_policy --num_of_scenarios 900 --steps 1000000 --save_freq 10000
