...
python examples/metadrive/run_bc_waymo.py --pkl_dir ~/src/data/metadrive/pkl_9/ --policy_load_dir examples/metadrive/example_policy/bc-diff-peak-10000.pt --use_diff_action_space True --num_of_scenarios 10000 --is_test True
...
python examples/metadrive/run_js_iql_waymo.py --use_transformer_expert False --pkl_dir ~/src/data/metadrive/pkl_9/  --num_of_scenarios 10000 --steps 1000000 --device cpu   --policy_load_dir tensorboard_log/bc-waymo-es0/BC_0/model.pt --use_diff_action=True
