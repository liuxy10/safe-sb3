...
# alternatively on server:
python examples/metadrive/run_bc_waymo.py --pkl_dir ~/src/data/metadrive/pkl_9/ --h5py_path /home/xinyi/src/data/metadrive/h5py/waymo_n_10000_lam_10.h5py --use_diff_action_space True --num_of_scenarios 10000 --steps 1000000
...
python examples/metadrive/run_js_sac_waymo.py --pkl_dir ~/src/data/metadrive/pkl_9/ --output_dir ~/src/data/metadrive/saved_sac_policy/ --num_of_scenarios 10000 --steps 1000000 --device cuda --expert_model_dir tensorboard_log/bc-waymo-es0/BC_0/model.pt --use_diff_action=True
# train iql with BC JumpStart
python examples/metadrive/run_js_iql_waymo.py --pkl_dir ~/src/data/metadrive/pkl_9/ --output_dir ~/src/data/metadrive/saved_sac_policy/ --num_of_scenarios 10000 --steps 1000000 --device cuda --expert_model_dir tensorboard_log/bc-waymo-es0/BC_0/model.pt --use_diff_action=True
