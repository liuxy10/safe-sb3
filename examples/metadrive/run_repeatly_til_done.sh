...
tada() {
    ...
    python ~/src/safe-sb3/examples/metadrive/combine_pkls_for_dt.py --pkl_dir ~/src/data/metadrive/pkl_9/ --dt_data_path ~/src/data/metadrive/dt_pkl/waymo_n_10000_lam_10_eps_10/eps_$eps.pkl --num_of_scenarios $n_per_eps --start_seed $start_seed
}

# loop through all data
for ((i=1; i<total_eps; i++)); do
    echo "Iteration $i"
